...
namespace Cooperchip.ITDeveloper.Mvc.Extensions.TagHelpers
{
    ...
    {
        [HtmlAttributeName("titulo")] public string Titulo { get; set; }
        [HtmlAttributeName("imagem")] public string Imagem { get; set; }
        [HtmlAttributeName("controlador")] public string Controlador { get; set; } 
        [HtmlAttributeName("visualizacao")] public string Visualizacao { get; set; }
