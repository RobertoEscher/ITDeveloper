...
namespace Cooperchip.ITDeveloper.Mvc.Areas.Identity.Pages.Account
{
    public class ConfirmarEmailLoginModel : PageModel
    {
        ...
        public ConfirmarEmailLoginModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSender.SendEmailAsync(email, "Confirme seu email antes de logar",
                $"Por gentileza confirme sua conta <a ref='{HtmlEncoder.Default.Encode(callbackUrl)}'> Clicando aqui<a>.");

            StatusMessage = "Verificação de conta enviada. Por gentileza verifique o seu email.";
