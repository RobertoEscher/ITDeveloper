            ...
            foreach (var item in Items)
            {
                ...
                foreach (var prop in props)
                {
                    ...
                    if (prop.Name.Equals("Id"))
                    {
                        ...
                        //output.Content.AppendHtml($"<td><a href='/{model}/Details/{value}' class='btn btn-default'>Detalhes</a>");
                        //output.Content.AppendHtml($"<a href='/{model}/Edit/{value}' class='btn btn-info'>Editar</a>");
                        //output.Content.AppendHtml($"<a href='/{model}/Delete/{value}' class='btn btn-danger'>Excluir</a></td>");
